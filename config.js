module.exports = {
  ...
  DASHBOARD: {
    ...
    baseURL: process.env.REPLIT_DEV_DOMAIN ? `https://${process.env.REPLIT_DEV_DOMAIN}` : "http://0.0.0.0:5000", // base url
    failureURL: process.env.REPLIT_DEV_DOMAIN ? `https://${process.env.REPLIT_DEV_DOMAIN}` : "http://0.0.0.0:5000", // failure redirect url
    port: process.env.PORT || "5000", // port to run the bot on
  },
